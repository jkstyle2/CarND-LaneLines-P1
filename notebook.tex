...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{}reading in an image}
        \PY{c+c1}{\PYZsh{} image = mpimg.imread(\PYZsq{}test\PYZus{}images/solidWhiteRight.jpg\PYZsq{})}
        \PY{n}{image} \PY{o}{=} \PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidWhiteCurve.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} image = mpimg.imread(\PYZsq{}test\PYZus{}images/solidYellowCurve.jpg\PYZsq{})}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}2}]:} <matplotlib.image.AxesImage at 0x7f0112d3d5f8>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}18}]:} \PY{k+kn}{import} \PY{n+nn}{math}
         ...
         \PY{l+s+sd}{    Only keeps the region of the image defined by the polygon formed from `vertices`. The rest of the image is set to black.}
         \PY{l+s+sd}{    `vertices` should be a numpy array of integer points.}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
         
             \PY{c+c1}{\PYZsh{} define a blank mask which matches the image height \PYZam{} width}
             \PY{n}{mask} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros\PYZus{}like}\PY{p}{(}\PY{n}{img}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{} define a 3 channel or 1 channel color to fill the mask with depending on the input image}
             ...
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{ignore\PYZus{}mask\PYZus{}color} \PY{o}{=} \PY{l+m+mi}{10}
             ...
             \PY{c+c1}{\PYZsh{} returning the image only where mask pixels match (nonzero)}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{} Output \PYZdq{}lines\PYZdq{} is an array containing endpoints of detected line segments}
             \PY{n}{lines} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{HoughLinesP}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{rho}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{threshold}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{minLineLength} \PY{o}{=} \PY{n}{min\PYZus{}line\PYZus{}len}\PY{p}{,} \PY{n}{maxLineGap} \PY{o}{=} \PY{n}{max\PYZus{}line\PYZus{}gap}\PY{p}{)} \PY{c+c1}{\PYZsh{} return (x,y)}
             \PY{c+c1}{\PYZsh{} print(lines) \PYZsh{}  return two endpoints of the deteced line segment : [x1, y1, x2, y2] }
             
             \PY{k}{return} \PY{n}{lines}
         
             
         \PY{c+c1}{\PYZsh{}     line\PYZus{}img = np.zeros((img.shape[0], img.shape[1], 3), dtype = np.uint8) \PYZsh{} blank image to draw lines on}
         ...
         \PY{k}{def} \PY{n+nf}{draw\PYZus{}lines}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{lines}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{255}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{thickness}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    NOTE: this is the function you might want to use as a starting point }
         \PY{l+s+sd}{    once you want to average/extrapolate the line segments you detect to map out }
         \PY{l+s+sd}{    the full extent of the lane (going from the result shown in raw\PYZhy{}lines\PYZhy{}example.mp4}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{c+c1}{\PYZsh{}     \PYZsh{}original code}
         ...
         \PY{c+c1}{\PYZsh{}             cv2.line(img, (x1, y1), (x2, y2), color, thickness)}
             ...
             \PY{n}{line\PYZus{}img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{n}{dtype} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)} \PY{c+c1}{\PYZsh{} blank image that matches the original in size}
             
             \PY{k}{if} \PY{n}{lines} \PY{o+ow}{is} \PY{k+kc}{None}\PY{p}{:}
                 \PY{k}{return}
             
             \PY{c+c1}{\PYZsh{} Loop over all lines and draw them on the blank image}
             \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{lines}\PY{p}{:}
         \PY{c+c1}{\PYZsh{}         print(\PYZdq{}line: \PYZdq{}, line)}
                 \PY{k}{for} \PY{n}{x1}\PY{p}{,} \PY{n}{y1}\PY{p}{,} \PY{n}{x2}\PY{p}{,} \PY{n}{y2} \PY{o+ow}{in} \PY{n}{line}\PY{p}{:}
         \PY{c+c1}{\PYZsh{}             print(\PYZdq{}x1,y1,x2,y2: \PYZdq{}, x1,y1,x2,y2)}
                     \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{line\PYZus{}img}\PY{p}{,} \PY{p}{(}\PY{n}{x1}\PY{p}{,} \PY{n}{y1}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{x2}\PY{p}{,} \PY{n}{y2}\PY{p}{)}\PY{p}{,} \PY{n}{color}\PY{p}{,} \PY{n}{thickness}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}             m = (y2 \PYZhy{} y1) / (x2 \PYZhy{} x1)}
         \PY{c+c1}{\PYZsh{}             if m \PYZlt{} 0:}
         \PY{c+c1}{\PYZsh{}                 m\PYZus{}left = m\PYZus{}left + m}
         \PY{c+c1}{\PYZsh{}                 x\PYZus{}left = x\PYZus{}left + (x1 + x2)}
         \PY{c+c1}{\PYZsh{}                 y\PYZus{}left = y\PYZus{}left + (y1 + y2)}
         \PY{c+c1}{\PYZsh{}                 num\PYZus{}left = num\PYZus{}left + 1}
         
         \PY{c+c1}{\PYZsh{}             else:}
         \PY{c+c1}{\PYZsh{}                 m\PYZus{}right = m\PYZus{}right + m}
         \PY{c+c1}{\PYZsh{}                 x\PYZus{}right = x\PYZus{}right + (x1+x2)}
         \PY{c+c1}{\PYZsh{}                 y\PYZus{}right = y\PYZus{}right + (y1+y2)}
         \PY{c+c1}{\PYZsh{}                 num\PYZus{}right = num\PYZus{}right + 1}
                 
             \PY{k}{return} \PY{n}{line\PYZus{}img}
                 
                 
                 
         \PY{c+c1}{\PYZsh{}\PYZsh{} define slope = (x(init),y(init)) to (x(last), y(last))        }
                 
         \PY{c+c1}{\PYZsh{}             if x1 and x2 \PYZlt{}= 500:}
         \PY{c+c1}{\PYZsh{}                 x\PYZus{}left.append(x1)}
         \PY{c+c1}{\PYZsh{}                 x\PYZus{}left.append(x2)}
         \PY{c+c1}{\PYZsh{}                 y\PYZus{}left.append(y1)}
         \PY{c+c1}{\PYZsh{}                 y\PYZus{}left.append(y2)}
                         
         \PY{c+c1}{\PYZsh{}             else:}
         \PY{c+c1}{\PYZsh{}                 x\PYZus{}right.append(x1)}
         \PY{c+c1}{\PYZsh{}                 x\PYZus{}right.append(x2)}
         \PY{c+c1}{\PYZsh{}                 y\PYZus{}right.append(y1)}
         \PY{c+c1}{\PYZsh{}                 y\PYZus{}right.append(y1)}
         \PY{c+c1}{\PYZsh{}                 cv2.line(img, (x1, y1), (x2, y2), color, thickness)}
         \PY{c+c1}{\PYZsh{}                 print(cv2.line(img, (x1, y1), (x2, y2), color, thickness))}
                         
                     
         \PY{c+c1}{\PYZsh{}     \PYZsh{} left line            }
         \PY{c+c1}{\PYZsh{}     x0 = x\PYZus{}left[0]}
         \PY{c+c1}{\PYZsh{}     y0 = y\PYZus{}left[0]}
             
         \PY{c+c1}{\PYZsh{}     x\PYZus{}left.sort()}
         \PY{c+c1}{\PYZsh{}     y\PYZus{}left.sort()}
         \PY{c+c1}{\PYZsh{}     len\PYZus{}x\PYZus{}left = len(x\PYZus{}left)}
         \PY{c+c1}{\PYZsh{}     len\PYZus{}y\PYZus{}left = len(y\PYZus{}left)}
             
         \PY{c+c1}{\PYZsh{}     m\PYZus{}left = (y\PYZus{}left[0] \PYZhy{} y\PYZus{}left[len\PYZus{}y\PYZus{}left \PYZhy{} 1]) / (x\PYZus{}left[len\PYZus{}x\PYZus{}left \PYZhy{} 1] \PYZhy{} x\PYZus{}left[0])}
         \PY{c+c1}{\PYZsh{}     b\PYZus{}left = y0 \PYZhy{} (x0 * m\PYZus{}left)}
         \PY{c+c1}{\PYZsh{}     x\PYZus{}start\PYZus{}left = int((540 \PYZhy{} b\PYZus{}left)/m\PYZus{}left)}
             
             
             \PY{c+c1}{\PYZsh{} right line \PYZhy{}\PYZgt{} [fail]. because it depends too much on the slope..}
         \PY{c+c1}{\PYZsh{}     x1 = x\PYZus{}right[0]}
         \PY{c+c1}{\PYZsh{}     y1 = y\PYZus{}right[0]}
         
         \PY{c+c1}{\PYZsh{}     x\PYZus{}right.sort()}
         \PY{c+c1}{\PYZsh{}     y\PYZus{}right.sort()}
         \PY{c+c1}{\PYZsh{}     len\PYZus{}x\PYZus{}right = len(x\PYZus{}right)}
         \PY{c+c1}{\PYZsh{}     len\PYZus{}y\PYZus{}right = len(y\PYZus{}right)}
             
         \PY{c+c1}{\PYZsh{}     m\PYZus{}right = (y\PYZus{}right[0] \PYZhy{} y\PYZus{}right[len\PYZus{}y\PYZus{}right \PYZhy{} 1]) / (x\PYZus{}right[0] \PYZhy{} x\PYZus{}right[len\PYZus{}x\PYZus{}right \PYZhy{} 1])}
         \PY{c+c1}{\PYZsh{}     b\PYZus{}right = y1 \PYZhy{} (x1 * m\PYZus{}right)}
         \PY{c+c1}{\PYZsh{}     x\PYZus{}start\PYZus{}right = int((540 \PYZhy{} b\PYZus{}right)/m\PYZus{}right)}
             
         \PY{c+c1}{\PYZsh{}     cv2.line(img, (x\PYZus{}left[0], y\PYZus{}left[0]), (x\PYZus{}left[len\PYZus{}x\PYZus{}left \PYZhy{} 1], y\PYZus{}left[len\PYZus{}y\PYZus{}left \PYZhy{} 1]), color, thickness )        \PYZsh{} test\PYZus{}images: solidWhiteRight}
         \PY{c+c1}{\PYZsh{}     cv2.line(img, (x\PYZus{}left[0], y\PYZus{}left[len\PYZus{}y\PYZus{}left \PYZhy{} 1]), (x\PYZus{}left[len\PYZus{}x\PYZus{}left \PYZhy{} 1], y\PYZus{}left[0]), color, thickness )        }
         \PY{c+c1}{\PYZsh{}     cv2.line(img, (x\PYZus{}start\PYZus{}left, 540), (x\PYZus{}left[len\PYZus{}x\PYZus{}left \PYZhy{} 1], y\PYZus{}left[0]), color, thickness )    }
         \PY{c+c1}{\PYZsh{}     cv2.line(img, (x\PYZus{}start\PYZus{}right, 540), (x\PYZus{}right[0], y\PYZus{}left[0]), color, thickness )    }
         ...
         \PY{c+c1}{\PYZsh{} Merge the image with the lines onto the original.}
         \PY{k}{def} \PY{n+nf}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{initial\PYZus{}img}\PY{p}{,} \PY{n}{α}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{β}\PY{o}{=}\PY{l+m+mf}{1.7}\PY{p}{,} \PY{n}{γ}\PY{o}{=}\PY{l+m+mf}{0.}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k}{def} \PY{n+nf}{test}\PY{p}{(}\PY{p}{)}\PY{p}{:}
         ...
         \PY{c+c1}{\PYZsh{}     list1.sort()}
             \PY{k}{return} \PY{n}{list1}\PY{p}{,} \PY{n}{list2}
         
         \PY{n}{whatarethey} \PY{o}{=} \PY{n}{test}\PY{p}{(}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{whatarethey}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{whatarethey}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
before you try the videos.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{k+kn}{import} \PY{n+nn}{os}
         \PY{n}{os}\PY{o}{.}\PY{n}{listdir}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images/}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} ['solidWhiteCurve.jpg',
...
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{}\PYZsh{} Convert to grayscale}
         ...
         \PY{c+c1}{\PYZsh{}\PYZsh{} Call Canny Edge Detection (return single pixels \PYZdq{}indicating an edge\PYZdq{}, but just a point, not a line)}
         \PY{n}{low\PYZus{}threshold} \PY{o}{=} \PY{l+m+mi}{100}
         \PY{n}{high\PYZus{}threshold} \PY{o}{=} \PY{l+m+mi}{200}
         \PY{n}{cannyed\PYZus{}image} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{Canny}\PY{p}{(}\PY{n}{gray\PYZus{}image}\PY{p}{,} \PY{n}{low\PYZus{}threshold}\PY{p}{,} \PY{n}{high\PYZus{}threshold}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{cannyed\PYZus{}image}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Greys\PYZus{}r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}
         
         
         \PY{c+c1}{\PYZsh{} Deifne and Crop the Region of Interest}
         \PY{n}{imshape} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}
         \PY{n}{ROI\PYZus{}vertices} \PY{o}{=} \PY{p}{[}
             \PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}
             \PY{p}{(}\PY{l+m+mi}{450}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,}
             \PY{p}{(}\PY{l+m+mi}{500}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,}
             \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}    
         \PY{p}{]}
         
         \PY{n}{cropped\PYZus{}image} \PY{o}{=} \PY{n}{region\PYZus{}of\PYZus{}interest}\PY{p}{(}
             \PY{n}{cannyed\PYZus{}image}\PY{p}{,} 
             \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{ROI\PYZus{}vertices}\PY{p}{]}\PY{p}{,} \PY{n}{dtype} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{)}\PY{p}{,}
         \PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{cropped\PYZus{}image}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Greys\PYZus{}r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}
         
         
         \PY{c+c1}{\PYZsh{}\PYZsh{} Hough Transform : link the pixels representing edges to make a line in common}
         \PY{n}{rho} \PY{o}{=} \PY{l+m+mi}{6} \PY{c+c1}{\PYZsh{} ditance resolution in pixels of the Hough grid}
         \PY{n}{theta} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{180} \PY{c+c1}{\PYZsh{}angular resolution in radians of the Hough grid   \PYZsh{}theta = np.pi/180}
         \PY{n}{threshold} \PY{o}{=} \PY{l+m+mi}{20} \PY{c+c1}{\PYZsh{} minimum number of votes (intersections in Hough grid cell) \PYZsh{}threshold = 20}
         \PY{n}{min\PYZus{}line\PYZus{}len} \PY{o}{=} \PY{l+m+mi}{3} \PY{c+c1}{\PYZsh{} minimum number of pixels making up a line \PYZsh{}min\PYZus{}line\PYZus{}len = 3}
         \PY{n}{max\PYZus{}line\PYZus{}gap} \PY{o}{=} \PY{l+m+mi}{10} \PY{c+c1}{\PYZsh{} maximum gap in pixels between connectable line segments \PYZsh{}max\PYZus{}line\PYZus{}gap = 10}
         
         \PY{n}{lines} \PY{o}{=} \PY{n}{hough\PYZus{}lines}\PY{p}{(}\PY{n}{cropped\PYZus{}image}\PY{p}{,} \PY{n}{rho}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{threshold}\PY{p}{,} \PY{n}{min\PYZus{}line\PYZus{}len}\PY{p}{,} \PY{n}{max\PYZus{}line\PYZus{}gap}\PY{p}{)} \PY{c+c1}{\PYZsh{} returns (x1, x2, y1, y2)}
         
         
         \PY{c+c1}{\PYZsh{}\PYZsh{} Rendering detected Hough LInes as an Overlay : detected lines on the original image}
         \PY{n}{line\PYZus{}image} \PY{o}{=} \PY{n}{draw\PYZus{}lines}\PY{p}{(}\PY{n}{cannyed\PYZus{}image}\PY{p}{,} \PY{n}{lines}\PY{p}{)} 
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{line\PYZus{}image}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}
         
         
         \PY{c+c1}{\PYZsh{}\PYZsh{} Merge the image with the lines onto the original}
         \PY{n}{merged\PYZus{}image} \PY{o}{=} \PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{line\PYZus{}image}\PY{p}{,} \PY{n}{image}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{merged\PYZus{}image}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}
         ...
         \PY{c+c1}{\PYZsh{} Create a Single Left and Right Lane LIne \PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}}
         \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{This can be done by fitting a simple linear model to the various endpoints of the line segments in each group,}
         \PY{l+s+sd}{then rendering a single overlay line on that linear model.}
         \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         
         \PY{c+c1}{\PYZsh{}\PYZsh{} Distinguish the Left and Right lane : Check the direction of the line\PYZsq{}s slope}
         \PY{n}{left\PYZus{}line\PYZus{}x} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{left\PYZus{}line\PYZus{}y} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{right\PYZus{}line\PYZus{}x} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{right\PYZus{}line\PYZus{}y} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         
         \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{lines}\PY{p}{:}
             \PY{k}{for} \PY{n}{x1}\PY{p}{,} \PY{n}{y1}\PY{p}{,} \PY{n}{x2}\PY{p}{,} \PY{n}{y2} \PY{o+ow}{in} \PY{n}{line}\PY{p}{:}
                 \PY{n}{slope} \PY{o}{=} \PY{p}{(}\PY{n}{y2} \PY{o}{\PYZhy{}} \PY{n}{y1}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{x2} \PY{o}{\PYZhy{}} \PY{n}{x1}\PY{p}{)}
         
                 \PY{k}{if} \PY{n}{slope} \PY{o}{\PYZlt{}} \PY{l+m+mi}{0}\PY{p}{:}    \PY{c+c1}{\PYZsh{} left group}
                     \PY{n}{left\PYZus{}line\PYZus{}x}\PY{o}{.}\PY{n}{extend}\PY{p}{(}\PY{p}{[}\PY{n}{x1}\PY{p}{,} \PY{n}{x2}\PY{p}{]}\PY{p}{)}
                     \PY{n}{left\PYZus{}line\PYZus{}y}\PY{o}{.}\PY{n}{extend}\PY{p}{(}\PY{p}{[}\PY{n}{y1}\PY{p}{,} \PY{n}{y2}\PY{p}{]}\PY{p}{)}
                 \PY{k}{else}\PY{p}{:}              \PY{c+c1}{\PYZsh{}right group}
                     \PY{n}{right\PYZus{}line\PYZus{}x}\PY{o}{.}\PY{n}{extend}\PY{p}{(}\PY{p}{[}\PY{n}{x1}\PY{p}{,} \PY{n}{x2}\PY{p}{]}\PY{p}{)}
                     \PY{n}{right\PYZus{}line\PYZus{}y}\PY{o}{.}\PY{n}{extend}\PY{p}{(}\PY{p}{[}\PY{n}{y1}\PY{p}{,} \PY{n}{y2}\PY{p}{]}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{}\PYZsh{} Create a Single Linear Representation of each Line Group}
         \PY{c+c1}{\PYZsh{} Two known value: y values for the top and bottom endpoints }
         \PY{n}{min\PYZus{}y} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{3} \PY{o}{/} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} Just below the horizon}
         \PY{n}{max\PYZus{}y} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{c+c1}{\PYZsh{} The bottom of the image}
         
         \PY{c+c1}{\PYZsh{} Get the parameters for 1D polynomial y = mx + b, which is fit to the points }
         \PY{n}{poly\PYZus{}left\PYZus{}param} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{polyfit}\PY{p}{(}\PY{n}{left\PYZus{}line\PYZus{}y}\PY{p}{,} \PY{n}{left\PYZus{}line\PYZus{}x}\PY{p}{,} \PY{n}{deg} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)} \PY{c+c1}{\PYZsh{}return (m,b)}
         \PY{n}{poly\PYZus{}right\PYZus{}param} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{polyfit}\PY{p}{(}\PY{n}{right\PYZus{}line\PYZus{}y}\PY{p}{,} \PY{n}{right\PYZus{}line\PYZus{}x}\PY{p}{,} \PY{n}{deg} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Get the Left Line}
         \PY{n}{poly\PYZus{}left\PYZus{}line} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{poly1d}\PY{p}{(}\PY{n}{poly\PYZus{}left\PYZus{}param}\PY{p}{)}
         \PY{n}{left\PYZus{}x\PYZus{}start} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{poly\PYZus{}left\PYZus{}line}\PY{p}{(}\PY{n}{max\PYZus{}y}\PY{p}{)}\PY{p}{)}
         \PY{n}{left\PYZus{}x\PYZus{}end} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{poly\PYZus{}left\PYZus{}line}\PY{p}{(}\PY{n}{min\PYZus{}y}\PY{p}{)}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Get the RIght LIne}
         \PY{n}{poly\PYZus{}right\PYZus{}line} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{poly1d}\PY{p}{(}\PY{n}{poly\PYZus{}right\PYZus{}param}\PY{p}{)}
         \PY{n}{right\PYZus{}x\PYZus{}start} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{poly\PYZus{}right\PYZus{}line}\PY{p}{(}\PY{n}{max\PYZus{}y}\PY{p}{)}\PY{p}{)}
         \PY{n}{right\PYZus{}x\PYZus{}end} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{poly\PYZus{}right\PYZus{}line}\PY{p}{(}\PY{n}{min\PYZus{}y}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{line\PYZus{}image\PYZus{}2} \PY{o}{=} \PY{n}{draw\PYZus{}lines}\PY{p}{(}
             \PY{n}{image}\PY{p}{,}
             \PY{p}{[}\PY{p}{[}
                 \PY{p}{[}\PY{n}{left\PYZus{}x\PYZus{}start}\PY{p}{,} \PY{n}{max\PYZus{}y}\PY{p}{,} \PY{n}{left\PYZus{}x\PYZus{}end}\PY{p}{,} \PY{n}{min\PYZus{}y}\PY{p}{]}\PY{p}{,}
                 \PY{p}{[}\PY{n}{right\PYZus{}x\PYZus{}start}\PY{p}{,} \PY{n}{max\PYZus{}y}\PY{p}{,} \PY{n}{right\PYZus{}x\PYZus{}end}\PY{p}{,} \PY{n}{min\PYZus{}y}\PY{p}{]}\PY{p}{,}
             \PY{p}{]}\PY{p}{]}\PY{p}{,}
             \PY{n}{thickness} \PY{o}{=} \PY{l+m+mi}{5}\PY{p}{,}
         \PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{line\PYZus{}image\PYZus{}2}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}
         
         
         
         \PY{n}{merged\PYZus{}image\PYZus{}2} \PY{o}{=} \PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{line\PYZus{}image\PYZus{}2}\PY{p}{,} \PY{n}{image}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{merged\PYZus{}image\PYZus{}2}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Build your pipeline that will draw lane lines on the test\PYZus{}images}
        ...
        \PY{c+c1}{\PYZsh{} Read in and grayscale the image}
        \PY{n}{image\PYZus{}gray} \PY{o}{=} \PY{n}{grayscale}\PY{p}{(}\PY{n}{image}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}gray}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        
        \PY{c+c1}{\PYZsh{} Gaussian smoothing}
        \PY{n}{kernel\PYZus{}size} \PY{o}{=} \PY{l+m+mi}{3}
        \PY{n}{image\PYZus{}gray\PYZus{}blur} \PY{o}{=} \PY{n}{gaussian\PYZus{}blur}\PY{p}{(}\PY{n}{image\PYZus{}gray}\PY{p}{,} \PY{n}{kernel\PYZus{}size}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}gray\PYZus{}blur}\PY{p}{)}
        
        
        \PY{c+c1}{\PYZsh{} Canny Edge detection}
        \PY{n}{low\PYZus{}threshold} \PY{o}{=} \PY{l+m+mi}{100}
        \PY{n}{high\PYZus{}threshold} \PY{o}{=} \PY{l+m+mi}{200}
        \PY{n}{image\PYZus{}canny} \PY{o}{=} \PY{n}{canny}\PY{p}{(}\PY{n}{image\PYZus{}gray\PYZus{}blur}\PY{p}{,} \PY{n}{low\PYZus{}threshold}\PY{p}{,} \PY{n}{high\PYZus{}threshold}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}canny}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Greys\PYZus{}r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        
        \PY{c+c1}{\PYZsh{} ROI Mask}
        \PY{n}{imshape} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape} \PY{c+c1}{\PYZsh{} shape: return image\PYZsq{}s array size as tuple(?)}
        
        \PY{c+c1}{\PYZsh{}vertices = np.array( [ [ (0, imshape[0]), (450, 320), (500, 320), (imshape[1], imshape[0]) ] ], dtype = np.int32)}
        
        \PY{n}{vertices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(} \PY{p}{[} \PY{p}{[} \PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{450}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{500}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)} \PY{p}{]} \PY{p}{]}\PY{p}{)}
        
        
        
        \PY{n}{image\PYZus{}ROI} \PY{o}{=} \PY{n}{region\PYZus{}of\PYZus{}interest}\PY{p}{(}\PY{n}{image\PYZus{}canny}\PY{p}{,} \PY{n}{vertices}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}ROI}\PY{p}{)}
        
        
        \PY{c+c1}{\PYZsh{} Hough transform}
        \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{Hough Algorithm steps}
        
        \PY{l+s+sd}{1. Corner or edge detection}
        \PY{l+s+sd}{    \PYZhy{} Take grey/binary image which have 0s indicating non\PYZhy{}edges and 1s indicating edges. This is the input image for Hough TF}
        \PY{l+s+sd}{2. Rho range and Theta range creation.}
        \PY{l+s+sd}{    \PYZhy{} }
        
        \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{n}{rho} \PY{o}{=} \PY{l+m+mi}{5} \PY{c+c1}{\PYZsh{} ditance resolution in pixels of the Hough grid}
        \PY{n}{theta} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{180} \PY{c+c1}{\PYZsh{}angular resolution in radians of the Hough grid}
        \PY{n}{threshold} \PY{o}{=} \PY{l+m+mi}{20} \PY{c+c1}{\PYZsh{} minimum number of votes (intersections in Hough grid cell)}
        \PY{n}{min\PYZus{}line\PYZus{}len} \PY{o}{=} \PY{l+m+mi}{3} \PY{c+c1}{\PYZsh{} minimum number of pixels making up a line}
        \PY{n}{max\PYZus{}line\PYZus{}gap} \PY{o}{=} \PY{l+m+mi}{10} \PY{c+c1}{\PYZsh{} maximum gap in pixels between connectable line segments}
        
        \PY{n}{image\PYZus{}hough\PYZus{}lines} \PY{o}{=} \PY{n}{hough\PYZus{}lines}\PY{p}{(}\PY{n}{image\PYZus{}ROI}\PY{p}{,} \PY{n}{rho}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{threshold}\PY{p}{,} \PY{n}{min\PYZus{}line\PYZus{}len}\PY{p}{,} \PY{n}{max\PYZus{}line\PYZus{}gap}\PY{p}{)} 
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}hough\PYZus{}lines}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Combine with image}
        \PY{n}{color\PYZus{}edges} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dstack}\PY{p}{(}\PY{p}{(}\PY{n}{image\PYZus{}canny}\PY{p}{,} \PY{n}{image\PYZus{}canny}\PY{p}{,} \PY{n}{image\PYZus{}canny}\PY{p}{)}\PY{p}{)}
        \PY{n}{image\PYZus{}combined} \PY{o}{=} \PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{image\PYZus{}hough\PYZus{}lines}\PY{p}{,} \PY{n}{color\PYZus{}edges}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}combined}\PY{p}{)}
        
        \PY{n}{image\PYZus{}combined2} \PY{o}{=} \PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{image\PYZus{}hough\PYZus{}lines}\PY{p}{,} \PY{n}{image}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{7}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}combined2}\PY{p}{)}
\end{Verbatim}
...
forum post} for more troubleshooting tips across operating systems.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} Import everything needed to edit/save/watch video clips}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{k}{def} \PY{n+nf}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(gray\PYZus{}image, cmap = \PYZsq{}gray\PYZsq{})}
         \PY{c+c1}{\PYZsh{}     plt.show}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(cannyed\PYZus{}image, cmap = \PYZsq{}Greys\PYZus{}r\PYZsq{})}
         \PY{c+c1}{\PYZsh{}     plt.show}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(cropped\PYZus{}image, cmap = \PYZsq{}Greys\PYZus{}r\PYZsq{})}
         ...
         \PY{c+c1}{\PYZsh{}     plt.show}
             ...
             \PY{n}{rho} \PY{o}{=} \PY{l+m+mi}{6} \PY{c+c1}{\PYZsh{} ditance resolution in pixels of the Hough grid}
             \PY{n}{theta} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{180} \PY{c+c1}{\PYZsh{}angular resolution in radians of the Hough grid   \PYZsh{}theta = np.pi/180}
             \PY{n}{threshold} \PY{o}{=} \PY{l+m+mi}{50} \PY{c+c1}{\PYZsh{} minimum number of votes (intersections in Hough grid cell) \PYZsh{}threshold = 20}
             \PY{n}{min\PYZus{}line\PYZus{}len} \PY{o}{=} \PY{l+m+mi}{20} \PY{c+c1}{\PYZsh{} minimum number of pixels making up a line \PYZsh{}min\PYZus{}line\PYZus{}len = 3}
             \PY{n}{max\PYZus{}line\PYZus{}gap} \PY{o}{=} \PY{l+m+mi}{10} \PY{c+c1}{\PYZsh{} maximum gap in pixels between connectable line segments \PYZsh{}max\PYZus{}line\PYZus{}gap = 10}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(line\PYZus{}image)}
         \PY{c+c1}{\PYZsh{}     plt.show}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(merged\PYZus{}image)}
         \PY{c+c1}{\PYZsh{}     plt.show}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(line\PYZus{}image\PYZus{}2)}
         \PY{c+c1}{\PYZsh{}     plt.show}
         ...
         \PY{c+c1}{\PYZsh{}     plt.figure()}
         \PY{c+c1}{\PYZsh{}     plt.imshow(merged\PYZus{}image\PYZus{}2)}
         \PY{c+c1}{\PYZsh{}     plt.show}
             
             \PY{n}{result} \PY{o}{=} \PY{n}{merged\PYZus{}image\PYZus{}2}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{white\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidWhiteRight.mp4}\PY{l+s+s1}{\PYZsq{}}
         ...
         \PY{c+c1}{\PYZsh{} yellow\PYZus{}output = \PYZsq{}test\PYZus{}videos\PYZus{}output/solidYellowLeft.mp4\PYZsq{}}
         
         \PY{c+c1}{\PYZsh{} \PYZsh{}\PYZsh{} To speed up the testing process you may want to try your pipeline on a shorter subclip of the video}
         \PY{c+c1}{\PYZsh{} \PYZsh{}\PYZsh{} To do so add .subclip(start\PYZus{}second,end\PYZus{}second) to the end of the line below}
         \PY{c+c1}{\PYZsh{} \PYZsh{}\PYZsh{} Where start\PYZus{}second and end\PYZus{}second are integer values representing the start and end of the subclip}
         
         \PY{c+c1}{\PYZsh{} \PYZsh{}\PYZsh{} You may also uncomment the following line for a subclip of the first 5 seconds}
         \PY{c+c1}{\PYZsh{} \PYZsh{}\PYZsh{}clip1 = VideoFileClip(\PYZdq{}test\PYZus{}videos/solidWhiteRight.mp4\PYZdq{}).subclip(0,5)}
         \PY{c+c1}{\PYZsh{} clip1 = VideoFileClip(\PYZdq{}test\PYZus{}videos/solidYellowLeft.mp4\PYZdq{})}
         \PY{c+c1}{\PYZsh{} yellow\PYZus{}clip = clip1.fl\PYZus{}image(process\PYZus{}image) \PYZsh{}NOTE: this function expects color images!!}
         \PY{c+c1}{\PYZsh{} \PYZpc{}time yellow\PYZus{}clip.write\PYZus{}videofile(yellow\PYZus{}output, audio=False)}
\end{Verbatim}
...
player of choice.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{n}{HTML}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
